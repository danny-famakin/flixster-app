...
The Flixster app shows the latest movies currently playing in theaters. The app utilizes the Movie Database API to display images and basic information about these movies to the user.
...
<img src='https://github.com/danny-famakin/flixster-app/blob/master/flixster.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
